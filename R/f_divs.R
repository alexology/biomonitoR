...
#' \enumerate{
#'  \item `results` Results of `f_divs()`.
#'  \item `traits` A `data.frame` containing the traits used for the calculations.
#'  \item `taxa` A `data.frame` containing the taxa used for the calculations.
...
f_divs <- function(x, trait_db = NULL, tax_lev = "Taxa", type = NULL, traitSel = FALSE, col_blocks = NULL, distance = "gower", zerodist_rm = FALSE, correction = "none", traceB = FALSE, set_param = list(max_nbdim = 15, prec = "Qt", tol = 1e-07, cor.zero = TRUE)) {
