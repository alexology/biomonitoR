...
f_disp <- function( x , traitDB = NULL, type = NULL , traitSel = FALSE , colB = NULL,  nbdim = "auto" , distance = "gower", zerodist_rm = FALSE , correction = "none" , traceB = FALSE , set_param = list( max_nbdim = 15 , prec = "Qt" , tol = 1e-07 , cor.zero = TRUE ) ){
  ...
  if( traceB ){
    ...
    res.list <- list( res , traitDB , DF , m , correction = correction ,  taxa.excluded , tax.na , df1 , df2 )
