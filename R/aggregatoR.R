...
aggregatoR <- function (x)
{
  ...
  if( ! check.pa ) ( phy.agg <- data.frame( phy.agg[ , 1 , drop = FALSE], ( phy.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( cla.agg <- data.frame( cla.agg[ , 1 , drop = FALSE], ( cla.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( scla.agg <- data.frame( scla.agg[ , 1 , drop = FALSE], ( scla.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) (ord.agg <- data.frame( ord.agg[ , 1 , drop = FALSE], ( ord.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( fam.agg <- data.frame( fam.agg[ , 1 , drop = FALSE], ( fam.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( sfam.agg <- data.frame( sfam.agg[ , 1 , drop = FALSE], ( sfam.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( tri.agg <- data.frame( tri.agg[ , 1 , drop = FALSE], ( tri.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( gen.agg <- data.frame( gen.agg[ , 1 , drop = FALSE], ( gen.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( spe.agg <- data.frame( spe.agg[ , 1 , drop = FALSE], ( spe.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( sspe.agg <- data.frame( sspe.agg[ , 1 , drop = FALSE], ( sspe.agg[ , -1] > 0 ) * 1 ) )
  ...
  if( ! check.pa ) ( tax.agg <- data.frame( tax.agg[ , 1 , drop = FALSE], ( tax.agg[ , -1] > 0 ) * 1 ) )
