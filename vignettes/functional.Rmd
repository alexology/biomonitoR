...
```{r pcoaAxes }
selectPcoaAxes( traits_dist , method = "cor" , tresh = 0.7)
selectPcoaAxes( traits_dist , method = "legendre" , tresh = 0.65)
selectPcoaAxes( traits_dist , method = "maire" , tresh = 0.01)
```
